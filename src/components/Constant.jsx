...
export const courses = [
...

  {
    ...
    eligibility: {
      Name: "Hotel Management",
      Duration: `Certificate and diploma: These courses usually take 1–1.5 years. 
      Undergraduate: These courses usually take 3–4 years, often offered as a Bachelor of Hotel Management (BHM) or Bachelor of Science (B.Sc.). 
      Postgraduate: These courses usually take 1–2 years, often offered as a Master of Science (M.Sc.) in Hotel Management or Master of Hotel Administration (MHA).`,
      Mode: "Regular",
